              ...
              <div class="comment-block">
                  ...
                  <span class="date pt-right">
                      <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ) ?>">
                        <?php printf( esc_attr__('%1$s at %2$s','sparklestore'), esc_html( get_comment_date() ),  esc_html( get_comment_time() ) ); ?>
                      </a>
                  </span>
...
if( class_exists( 'WP_Customize_control') ) {
    ...
    class Sparklestore_Image_Radio_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <div id="input_<?php echo esc_attr( $this->id ); ?>" class="sparklestoreimage">
...
if ( ! function_exists( 'sparklestore_root_register_required_plugins' ) ) {
  function sparklestore_root_register_required_plugins() {
      ...
      $plugins = array(
          ...
          array(
              'name' => esc_html__('WooCommerce','sparklestore'),
              'slug' => 'woocommerce',
              'required' => false,
          ),
          array(
              'name' => esc_html__('YITH WooCommerce Quick View','sparklestore'),
              'slug' => 'yith-woocommerce-quick-view',
              'required' => false,
          ),

           array(
              'name' => esc_html__('YITH WooCommerce Compare','sparklestore'),
              'slug' => 'yith-woocommerce-compare',
              'required' => false,
          ),

          array(
              'name' => esc_html__('YITH WooCommerce Wishlist','sparklestore'),
              'slug' => 'yith-woocommerce-wishlist',
              'required' => false,
          ),

          array(
            'name' => esc_html__('WooCommerce Grid / List toggle','sparklestore'),
